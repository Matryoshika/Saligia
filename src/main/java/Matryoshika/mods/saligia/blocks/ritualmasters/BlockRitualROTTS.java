...
public class BlockRitualROTTS extends BlockContainer implements ITileEntityProvider {
	...
	public BlockRitualROTTS (Block BlockRitualCentre){
		super(Material.rock);
		setStepSound(soundTypeStone);
		setBlockTextureName(saligia.MODID+":BlockRitualCentre");
		setHardness(10);
		this.setResistance(150);
		this.setBlockName("BlockRitualROTTS");
